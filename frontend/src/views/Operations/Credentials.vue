<template>
  <el-main>
    <el-row>
      ...
      <el-col :span="4">
        <el-input v-model="credentialSearch" :placeholder="$t('ui.filterTip')"/>
      </el-col>
    </el-row>
    <el-table :data="credentialData.filter(data => !credentialSearch || data.username.toLowerCase().includes(credentialSearch.toLowerCase()))"
      :default-sort="{ prop: 'name', order: 'ascending' }">
      <el-table-column prop="name" :label="$t('ui.name')" sortable width="180"/>
      <el-table-column prop="description" :label="$t('ui.description')"/>
      <el-table-column prop="type" :label="$t('ui.type')"
        :filters="typeFilter"
