<template>
  <el-container style="height: 100%">
    <el-header style="padding: 0px; background-color: white; border-bottom: solid 1px #e6e6e6; height: 61px;">
      ...
      <el-menu mode="horizontal" router :default-active="$route.path" class="float-left">
...
.logo {
  ...
  float: left;
  transition: .3s width ease-in-out, .3s background-image ease-in-out;
}
.logo--collapse {
  width: 64px;
}
